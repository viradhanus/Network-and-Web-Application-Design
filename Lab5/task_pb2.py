...
_TASKAPI = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='nondestructive_editTask',
    full_name='Taskapi.nondestructive_editTask',
    index=2,
    containing_service=None,
    input_type=_TASK,
    output_type=_TASK,
  ...
  _descriptor.MethodDescriptor(
    name='destructive_editTask',
    full_name='Taskapi.destructive_editTask',
    index=3,
    containing_service=None,
    input_type=_TASK,
    output_type=_TASK,
